...
def submitdatabase_edit():
    ...
    new_recipedbpath_edit= r'./Recipes' + f'/{rnbox_editrecipe.get()}' + f'{new_recipedb}'
    new_recipefolderpath_edit = r'./Recipes' + f'/{rnbox_editrecipe.get()}'
    print(new_recipefolderpath_edit)
    os.chdir(r'./Recipes')
    if not os.path.exists(new_recipefolderpath_edit):
        print(f'./{old_recipename}')
        rmtree(f'./{old_recipename}')
        os.chdir('..')        
        os.mkdir(new_recipefolderpath_edit)
        os.chdir('..')
        print('fun')
    else:
        pass      
    ...
    edbcurs.execute('DELETE FROM basicinfo')
                    
    edbcurs.execute('DELETE FROM ingredientitems')   
                    
    edbcurs.execute('DELETE FROM  ingredientamounts')    
                    
    edbcurs.execute('DELETE FROM ingredientunits')    
                    
    edbcurs.execute('DELETE FROM additionalnotes')    
                      
    edbcurs.execute('DELETE FROM preparationsteps')    
...
def editdatabase(recipe):
    ...
    old_recipedbpath_edit = r'c:/Users/Ryan/Recipe Index Project/Recipes' + f'/{recipe}/{recipe}.db'
    ...
    editrecipe.iconbitmap('c:/Users/Ryan/Recipe Index Project/resources/img/Ico.ico')
