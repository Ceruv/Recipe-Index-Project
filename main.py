...
from appearance_config import mainbgcolor, mainfgcolor, applicationfont, changesettings
...
root = Tk()
windowconfiguration(root, 'Recipe Index Project (Alpha ver. 2.1.1)', './resources/img/Ico.ico', mainbgcolor, '', '', '', '', '')
...
interactivebuttoncreation('settingsbutton_hmpg',root,'Settings', applicationfont, 10, 'normal', mainfgcolor, mainbgcolor,'grid', 7,0,3,53,2, lambda: changesettings(), '','')
